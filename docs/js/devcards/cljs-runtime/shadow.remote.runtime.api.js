...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_45556 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_45556(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_45558 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_45558(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_45569 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_45569(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_45575 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_45575(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_45580 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_45580(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_45588 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_45588(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__45534,callback){
var map__45535 = p__45534;
var map__45535__$1 = cljs.core.__destructure_map(map__45535);
var input = map__45535__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45535__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45535__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
