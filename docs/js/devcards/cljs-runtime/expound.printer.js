...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56099_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__56099_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56100_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__56100_SHARP_)));
}),row));
});
...
var G__56102 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__56103 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__56102,G__56103) : expound.printer.format.call(null,G__56102,G__56103));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56104_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__56104_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56105_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__56105_SHARP_)).length),"="));
}),header);
...
var iter__4652__auto__ = (function expound$printer$multirow_$_iter__56112(s__56113){
return (new cljs.core.LazySeq(null,(function (){
var s__56113__$1 = s__56113;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__56113__$1);
if(temp__5753__auto__){
var s__56113__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56113__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__56113__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__56115 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__56114 = (0);
while(true){
if((i__56114 < size__4651__auto__)){
var row_idx = cljs.core._nth(c__4650__auto__,i__56114);
cljs.core.chunk_append(b__56115,(function (){var iter__4652__auto__ = ((function (i__56114,row_idx,c__4650__auto__,size__4651__auto__,b__56115,s__56113__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__56112_$_iter__56118(s__56119){
return (new cljs.core.LazySeq(null,((function (i__56114,row_idx,c__4650__auto__,size__4651__auto__,b__56115,s__56113__$2,temp__5753__auto__,split_row_contents){
return (function (){
var s__56119__$1 = s__56119;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__56119__$1);
if(temp__5753__auto____$1){
var s__56119__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__56119__$2)){
var c__4650__auto____$1 = cljs.core.chunk_first(s__56119__$2);
var size__4651__auto____$1 = cljs.core.count(c__4650__auto____$1);
var b__56121 = cljs.core.chunk_buffer(size__4651__auto____$1);
if((function (){var i__56120 = (0);
while(true){
if((i__56120 < size__4651__auto____$1)){
var col_idx = cljs.core._nth(c__4650__auto____$1,i__56120);
cljs.core.chunk_append(b__56121,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__56397 = (i__56120 + (1));
i__56120 = G__56397;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56121),expound$printer$multirow_$_iter__56112_$_iter__56118(cljs.core.chunk_rest(s__56119__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56121),null);
}
} else {
var col_idx = cljs.core.first(s__56119__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__56112_$_iter__56118(cljs.core.rest(s__56119__$2)));
}
} else {
return null;
}
...
});})(i__56114,row_idx,c__4650__auto__,size__4651__auto__,b__56115,s__56113__$2,temp__5753__auto__,split_row_contents))
,null,null));
});})(i__56114,row_idx,c__4650__auto__,size__4651__auto__,b__56115,s__56113__$2,temp__5753__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56115),expound$printer$multirow_$_iter__56112(cljs.core.chunk_rest(s__56113__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56115),null);
}
} else {
var row_idx = cljs.core.first(s__56113__$2);
return cljs.core.cons((function (){var iter__4652__auto__ = ((function (row_idx,s__56113__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__56112_$_iter__56133(s__56134){
return (new cljs.core.LazySeq(null,(function (){
var s__56134__$1 = s__56134;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__56134__$1);
if(temp__5753__auto____$1){
var s__56134__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__56134__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__56134__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__56136 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__56135 = (0);
while(true){
if((i__56135 < size__4651__auto__)){
var col_idx = cljs.core._nth(c__4650__auto__,i__56135);
cljs.core.chunk_append(b__56136,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__56401 = (i__56135 + (1));
i__56135 = G__56401;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56136),expound$printer$multirow_$_iter__56112_$_iter__56133(cljs.core.chunk_rest(s__56134__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56136),null);
}
} else {
var col_idx = cljs.core.first(s__56134__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__56112_$_iter__56133(cljs.core.rest(s__56134__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__56113__$2,temp__5753__auto__,split_row_contents))
;
return iter__4652__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__56112(cljs.core.rest(s__56113__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56141_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__56141_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__56177 = via;
var G__56177__$1 = (((G__56177 == null))?null:cljs.core.last(G__56177));
if((G__56177__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__56177__$1);
}
})();
...
var seq__56180_56406 = cljs.core.seq(problems);
var chunk__56181_56407 = null;
var count__56182_56408 = (0);
var i__56183_56409 = (0);
while(true){
if((i__56183_56409 < count__56182_56408)){
var p_56410 = chunk__56181_56407.cljs$core$IIndexed$_nth$arity$2(null,i__56183_56409);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_56410) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__56412 = seq__56180_56406;
var G__56413 = chunk__56181_56407;
var G__56414 = count__56182_56408;
var G__56415 = (i__56183_56409 + (1));
seq__56180_56406 = G__56412;
chunk__56181_56407 = G__56413;
count__56182_56408 = G__56414;
i__56183_56409 = G__56415;
continue;
} else {
var temp__5753__auto___56416 = cljs.core.seq(seq__56180_56406);
if(temp__5753__auto___56416){
var seq__56180_56417__$1 = temp__5753__auto___56416;
if(cljs.core.chunked_seq_QMARK_(seq__56180_56417__$1)){
var c__4679__auto___56418 = cljs.core.chunk_first(seq__56180_56417__$1);
var G__56419 = cljs.core.chunk_rest(seq__56180_56417__$1);
var G__56420 = c__4679__auto___56418;
var G__56421 = cljs.core.count(c__4679__auto___56418);
var G__56422 = (0);
seq__56180_56406 = G__56419;
chunk__56181_56407 = G__56420;
count__56182_56408 = G__56421;
i__56183_56409 = G__56422;
continue;
} else {
var p_56423 = cljs.core.first(seq__56180_56417__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_56423) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__56425 = cljs.core.next(seq__56180_56417__$1);
var G__56426 = null;
var G__56427 = (0);
var G__56428 = (0);
seq__56180_56406 = G__56425;
chunk__56181_56407 = G__56426;
count__56182_56408 = G__56427;
i__56183_56409 = G__56428;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__4253__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__56178_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__56178_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__56191){
var vec__56192 = p__56191;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56192,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56192,(1),null);
var G__56195 = branch;
var G__56195__$1 = (((G__56195 instanceof cljs.core.Keyword))?G__56195.fqn:null);
switch (G__56195__$1) {
case "simple":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56195__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__56204 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56204,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56204,(1),null);
var G__56210 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56210__$1)].join('')));
...
var len__4864__auto___56440 = arguments.length;
var i__4865__auto___56442 = (0);
while(true){
if((i__4865__auto___56442 < len__4864__auto___56440)){
args__4870__auto__.push((arguments[i__4865__auto___56442]));

var G__56443 = (i__4865__auto___56442 + (1));
i__4865__auto___56442 = G__56443;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq56211){
var G__56213 = cljs.core.first(seq56211);
var seq56211__$1 = cljs.core.next(seq56211);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56213,seq56211__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56222_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__56222_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__56223_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__56223_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__56226){
var vec__56227 = p__56226;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56227,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56227,(1),null);
...
var _STAR_print_newline_STAR__orig_val__56231_56453 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56232_56454 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56233_56455 = true;
var _STAR_print_fn_STAR__temp_val__56234_56456 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56233_56455);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56234_56456);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56232_56454);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56231_56453);
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56240_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__56240_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__56281 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
...
var line = first__56283;
var lines = seq__56282__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56277_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__56277_SHARP_)].join('');
}),lines)));
}));
...
while(true){
var vec__56303 = in$;
var seq__56304 = cljs.core.seq(vec__56303);
var first__56305 = cljs.core.first(seq__56304);
var seq__56304__$1 = cljs.core.next(seq__56304);
var k = first__56305;
var rst = seq__56304__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__56310 = show_valid_values_QMARK_;
var G__56311 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__56312 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__56310,G__56311,G__56312) : expound.printer.summary_form.call(null,G__56310,G__56311,G__56312));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__56481 = show_valid_values_QMARK_;
var G__56482 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__56483 = rst__$1;
show_valid_values_QMARK_ = G__56481;
form = G__56482;
in$ = G__56483;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__56318 = show_valid_values_QMARK_;
var G__56319 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__56320 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__56318,G__56319,G__56320) : expound.printer.summary_form.call(null,G__56318,G__56319,G__56320));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__56322 = show_valid_values_QMARK_;
var G__56323 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__56324 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__56322,G__56323,G__56324) : expound.printer.summary_form.call(null,G__56322,G__56323,G__56324));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__56325 = show_valid_values_QMARK_;
var G__56326 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__56327 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__56325,G__56326,G__56327) : expound.printer.summary_form.call(null,G__56325,G__56326,G__56327));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__56330 = show_valid_values_QMARK_;
var G__56331 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__56332 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__56330,G__56331,G__56332) : expound.printer.summary_form.call(null,G__56330,G__56331,G__56332));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56333_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__56333_SHARP_)).length);
...
var map__56343 = problem;
var map__56343__$1 = cljs.core.__destructure_map(map__56343);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56343__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56343__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__56344 = opts;
var map__56344__$1 = cljs.core.__destructure_map(map__56344);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56344__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__56349 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__56350 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__56350);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__56349);
}})();
var vec__56345 = cljs.core.re_find(regex,s);
...
var line = first__56347;
var first__56347__$1 = cljs.core.first(seq__56346__$1);
var seq__56346__$2 = cljs.core.next(seq__56346__$1);
var prefix = first__56347__$1;
var _more = seq__56346__$2;
