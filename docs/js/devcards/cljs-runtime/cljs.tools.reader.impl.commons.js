...
var G__41531 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__41531;
continue;
} else {
return ch;
...
var vec__41505 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41505,(0),null);
return (match === s);
});
...
var len__4864__auto___41552 = arguments.length;
var i__4865__auto___41553 = (0);
while(true){
if((i__4865__auto___41553 < len__4864__auto___41552)){
args__4870__auto__.push((arguments[i__4865__auto___41553]));

var G__41554 = (i__4865__auto___41553 + (1));
i__4865__auto___41553 = G__41554;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq41517){
var G__41518 = cljs.core.first(seq41517);
var seq41517__$1 = cljs.core.next(seq41517);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41518,seq41517__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__41556__delegate = function (rdr,_){
...
var G__41556 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__41558__i = 0, G__41558__a = new Array(arguments.length -  1);
while (G__41558__i < G__41558__a.length) {G__41558__a[G__41558__i] = arguments[G__41558__i + 1]; ++G__41558__i;}
  _ = new cljs.core.IndexedSeq(G__41558__a,0,null);
} 
return G__41556__delegate.call(this,rdr,_);};
G__41556.cljs$lang$maxFixedArity = 1;
G__41556.cljs$lang$applyTo = (function (arglist__41559){
var rdr = cljs.core.first(arglist__41559);
var _ = cljs.core.rest(arglist__41559);
return G__41556__delegate(rdr,_);
});
