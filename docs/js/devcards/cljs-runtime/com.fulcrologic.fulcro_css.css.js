...
return garden.selectors.selector(clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58000_SHARP_){
if(com.fulcrologic.fulcro_css.css_implementation.prefixed_name_QMARK_(p1__58000_SHARP_)){
return com.fulcrologic.fulcro_css.css_implementation.localize_name(p1__58000_SHARP_,comp);
} else {
return p1__58000_SHARP_;
}
}),split_cns_selectors)));
});
/**
...
var nested_children_rules = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58005_SHARP_,p2__58006_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(p1__58005_SHARP_,com.fulcrologic.fulcro_css.css.get_css_rules(p2__58006_SHARP_));
