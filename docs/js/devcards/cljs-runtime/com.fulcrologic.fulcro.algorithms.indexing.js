...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__52480){
var map__52481 = p__52480;
var map__52481__$1 = cljs.core.__destructure_map(map__52481);
var ast = map__52481__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52481__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52481__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__52485){
var map__52487 = p__52485;
var map__52487__$1 = cljs.core.__destructure_map(map__52487);
var child_ast = map__52487__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52487__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52487__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52487__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var G__52489 = idx;
var G__52489__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__52489,dispatch_key,parent_key):G__52489);
var G__52489__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__52489__$1,key,parent_key):G__52489__$1);
var G__52489__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__52489__$2,key,parent_key):G__52489__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__52489__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null,G__52489__$3,child_ast));
} else {
return G__52489__$3;
}
...
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52499__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__52504){
var map__52505 = p__52504;
var map__52505__$1 = cljs.core.__destructure_map(map__52505);
var ast = map__52505__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52505__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52505__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
}),null)),null,-1302325514,null);

var map__52520 = app;
var map__52520__$1 = cljs.core.__destructure_map(map__52520);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52520__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52520__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var map__52521 = cljs.core.deref(runtime_atom);
var map__52521__$1 = cljs.core.__destructure_map(map__52521);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52521__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__52554 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__52554__$1 = cljs.core.__destructure_map(map__52554);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52554__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var map__52600 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__52600__$1 = cljs.core.__destructure_map(map__52600);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52600__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.raw.components.component_type(this$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__52632){
var map__52633 = p__52632;
var map__52633__$1 = cljs.core.__destructure_map(map__52633);
var app = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52633__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__52634_52687 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__52635_52688 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__52635_52688);
...
}),null)),null,-1981052093,null);
}
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__52634_52687);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__52639 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__52640 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__52640);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__52639);
}})], null);
}));
