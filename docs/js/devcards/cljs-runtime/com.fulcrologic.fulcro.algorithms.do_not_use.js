...
var vec__44967 = ((cljs.core.seq_QMARK_(expr))?cljs.core.ffirst(expr):cljs.core.first(expr));
...
var expr__$1 = (function (){var G__44992 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__44992);
} else {
return G__44992;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__45009 = cljs.core.first(expr);
return (com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1(G__45009) : com.fulcrologic.fulcro.algorithms.do_not_use.join_key.call(null,G__45009));
} else {
return expr;
...
var len__4864__auto___45149 = arguments.length;
var i__4865__auto___45150 = (0);
while(true){
if((i__4865__auto___45150 < len__4864__auto___45149)){
args__4870__auto__.push((arguments[i__4865__auto___45150]));

var G__45152 = (i__4865__auto___45150 + (1));
i__4865__auto___45150 = G__45152;
continue;
} else {
}
break;
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$lang$applyTo = (function (seq45024){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45024));
}));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["The composed root query is not valid EQL. The app may crash. See `(comp/get-query ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__45097 = query;
var G__45097__$1 = (((G__45097 == null))?null:cljs.core.meta(G__45097));
var G__45097__$2 = (((G__45097__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__45097__$1));
if((G__45097__$2 == null)){
return null;
} else {
return (component_name_fn.cljs$core$IFn$_invoke$arity$1 ? component_name_fn.cljs$core$IFn$_invoke$arity$1(G__45097__$2) : component_name_fn.call(null,G__45097__$2));
}
})()),")`"].join(''),query], null);
}),null)),null,-1021652817,null);
} else {
}
