...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__47293){
var vec__47294 = p__47293;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47294,(0),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__47316_SHARP_){
return (((p1__47316_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__47316_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__47337,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__47337;
}
});
...
var len__4864__auto___47472 = arguments.length;
var i__4865__auto___47474 = (0);
while(true){
if((i__4865__auto___47474 < len__4864__auto___47472)){
args__4870__auto__.push((arguments[i__4865__auto___47474]));

var G__47475 = (i__4865__auto___47474 + (1));
i__4865__auto___47474 = G__47475;
continue;
} else {
}
break;
...
var G__47344 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47344,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__47344;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq47340){
...
var vec__47392 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__47401 = cljs.core.ffirst(matches);
var fexpr__47399 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__47399.cljs$core$IFn$_invoke$arity$1 ? fexpr__47399.cljs$core$IFn$_invoke$arity$1(G__47401) : fexpr__47399.call(null,G__47401));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47392,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47392,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__47386_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__47386_SHARP_))){
return p1__47386_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__47390_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__47390_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__47439){
var vec__47440 = p__47439;
var seq__47441 = cljs.core.seq(vec__47440);
var first__47442 = cljs.core.first(seq__47441);
var seq__47441__$1 = cljs.core.next(seq__47441);
var tag = first__47442;
var content = seq__47441__$1;
...
var vec__47450 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47450,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47450,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47450,(2),null);
