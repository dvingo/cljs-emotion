...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41022){
var G__41023 = cljs.core.first(seq41022);
var seq41022__$1 = cljs.core.next(seq41022);
var G__41024 = cljs.core.first(seq41022__$1);
var seq41022__$2 = cljs.core.next(seq41022__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41023,G__41024,seq41022__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41045_SHARP_){
return (!((cljs.core.meta(p1__41045_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41081__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41082){var _e__40212__auto__ = e41082;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e41084){var _e__40212__auto__ = e41084;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41089 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41090 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41090);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41091__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41089);
}});
...
var temp__5751__auto___41117 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___41117)){
var managed_print_level_41118 = temp__5751__auto___41117;
var _STAR_print_level_STAR__orig_val__41100_41119 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41101_41120 = managed_print_level_41118;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41101_41120);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41099_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41099_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41100_41119);
}} else {
job_fn();
}
