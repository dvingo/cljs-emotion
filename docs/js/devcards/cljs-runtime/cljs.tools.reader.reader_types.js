...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41292 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41292(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41300 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41300(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41302 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41302(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41307 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41307(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41308 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41308(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41313 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41313(reader);
}
});
...
var G__41401 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41402 = s.append(c);
c = G__41401;
s = G__41402;
continue;
}
