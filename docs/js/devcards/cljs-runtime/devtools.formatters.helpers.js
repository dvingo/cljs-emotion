...
var G__41009 = devtools.prefs.pref(v);
v = G__41009;
continue;
} else {
return v;
...
}catch (e40939){var _e__40212__auto__ = e40939;
return false;
}})();
...
}catch (e40947){var _e__40212__auto__ = e40947;
return false;
}})();
...
}catch (e40950){var _e__40212__auto__ = e40950;
return false;
}}
}
});
...
var vec__40974 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40974,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40974,(1),null);
...
return cljs.core.some((function (p1__40985_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__40985_SHARP_);
}),template);
});
