...
var i_42577 = (0);
while(true){
if((i_42577 < arr.length)){
(arr[i_42577] = null);

var G__42582 = (i_42577 + (1));
i_42577 = G__42582;
continue;
} else {
}
...
var i_42591 = (self__.level + (1));
while(true){
if((i_42591 <= (new_level + (1)))){
(update[i_42591] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_42593 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_42593[i]));
} else {
x__$2.forward.push((((i < links_42593.length))?(links_42593[i]):null));
}

if((i < links_42593.length)){
(links_42593[i] = x__$2);
} else {
links_42593.push(x__$2);
}
...
var i_42596 = (0);
while(true){
if((i_42596 <= self__.level)){
var links_42597 = (update[i_42596]).forward;
if((x__$1 === (((i_42596 < links_42597.length))?(links_42597[i_42596]):null))){
(links_42597[i_42596] = (x__$1.forward[i_42596]));

var G__42598 = (i_42596 + (1));
i_42596 = G__42598;
continue;
} else {
var G__42599 = (i_42596 + (1));
i_42596 = G__42599;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__42609 = nx;
var G__42610 = (level__$1 - (1));
x = G__42609;
level__$1 = G__42610;
continue;
} else {
var G__42611 = x;
var G__42612 = (level__$1 - (1));
x = G__42611;
level__$1 = G__42612;
continue;
}
