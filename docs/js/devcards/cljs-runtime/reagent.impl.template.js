...
var G__48944 = o;
reagent.impl.template.goog$module$goog$object.set(G__48944,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__49135__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__49135 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__49137__i = 0, G__49137__a = new Array(arguments.length -  0);
while (G__49137__i < G__49137__a.length) {G__49137__a[G__49137__i] = arguments[G__49137__i + 0]; ++G__49137__i;}
  args = new cljs.core.IndexedSeq(G__49137__a,0,null);
} 
return G__49135__delegate.call(this,args);};
G__49135.cljs$lang$maxFixedArity = 0;
G__49135.cljs$lang$applyTo = (function (arglist__49138){
var args = cljs.core.seq(arglist__49138);
return G__49135__delegate(args);
});
...
var G__48956 = o;
reagent.impl.template.goog$module$goog$object.set(G__48956,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__49144__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__49144 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__49145__i = 0, G__49145__a = new Array(arguments.length -  0);
while (G__49145__i < G__49145__a.length) {G__49145__a[G__49145__i] = arguments[G__49145__i + 0]; ++G__49145__i;}
  args = new cljs.core.IndexedSeq(G__49145__a,0,null);
} 
return G__49144__delegate.call(this,args);};
G__49144.cljs$lang$maxFixedArity = 0;
G__49144.cljs$lang$applyTo = (function (arglist__49146){
var args = cljs.core.seq(arglist__49146);
return G__49144__delegate(args);
});
...
var G__48963 = props;
var G__48963__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48963,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__48963);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48963__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__48969 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48969,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__48969;
}
})(),id_class);
...
var G__48972 = (cljs.core.count(argv) - first_child);
switch (G__48972) {
case (0):
...
var vec__48984 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48984,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48984,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48984,(2),null);
...
var temp__5757__auto___49172 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___49172 == null)){
} else {
var key_49173 = temp__5757__auto___49172;
(jsprops.key = key_49173);
}
...
var temp__5757__auto___49176 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___49176 == null)){
} else {
var key_49177 = temp__5757__auto___49176;
(jsprops.key = key_49177);
}
...
var temp__5757__auto___49184 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___49184 == null)){
} else {
var key_49185 = temp__5757__auto___49184;
(jsprops.key = key_49185);
}
...
var temp__5757__auto___49193 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___49193 == null)){
} else {
var key_49194 = temp__5757__auto___49193;
(jsprops.key = key_49194);
}
...
var temp__5757__auto___49198 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___49198 == null)){
} else {
var key_49199 = temp__5757__auto___49198;
(jsprops.key = key_49199);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49028_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__49028_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__49037 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49037,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49037,(1),null);
...
break;
default:
var G__49205 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__49206 = compiler;
v = G__49205;
compiler = G__49206;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template49096 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template49096 = (function (opts,id,fn_to_element,parse_fn,meta49097){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template49096.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_49098,meta49097__$1){
var self__ = this;
var _49098__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template49096(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta49097__$1));
}));

(reagent.impl.template.t_reagent$impl$template49096.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_49098){
var self__ = this;
var _49098__$1 = this;
return self__.meta49097;
}));

(reagent.impl.template.t_reagent$impl$template49096.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template49096.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template49096.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template49096.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template49096.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template49096.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta49097","meta49097",54693622,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template49096.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template49096.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template49096");

(reagent.impl.template.t_reagent$impl$template49096.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template49096");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template49096.
 */
reagent.impl.template.__GT_t_reagent$impl$template49096 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template49096(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta49097){
return (new reagent.impl.template.t_reagent$impl$template49096(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta49097));
});

}

return (new reagent.impl.template.t_reagent$impl$template49096(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
