...
var len__4864__auto___45283 = arguments.length;
var i__4865__auto___45284 = (0);
while(true){
if((i__4865__auto___45284 < len__4864__auto___45283)){
args__4870__auto__.push((arguments[i__4865__auto___45284]));

var G__45286 = (i__4865__auto___45284 + (1));
i__4865__auto___45284 = G__45286;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__45106_45290 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__45107_45291 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__45108_45292 = true;
var _STAR_print_fn_STAR__temp_val__45109_45293 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__45108_45292);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__45109_45293);

try{var _STAR_print_level_STAR__orig_val__45113_45295 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__45114_45296 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__45114_45296);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__45113_45295);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__45107_45291);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__45106_45290);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq45105){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45105));
}));
...
var new_formatters = current_formatters.filter((function (p1__45138_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__45138_SHARP_)));
}));
...
var G__45152_45328 = f;
var target__40206__auto___45329 = G__45152_45328;
if(cljs.core.truth_(target__40206__auto___45329)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45152_45328)].join(''),"\n","target__40206__auto__"].join('')));
}

(target__40206__auto___45329["toString"] = (function (){
...
var G__45155_45332 = "%c%s";
var G__45156_45333 = "color:transparent";
var G__45157_45334 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__45155_45332,G__45156_45333,G__45157_45334) : f.call(null,G__45155_45332,G__45156_45333,G__45157_45334));
...
var args__4870__auto__ = [];
var len__4864__auto___45341 = arguments.length;
var i__4865__auto___45342 = (0);
while(true){
if((i__4865__auto___45342 < len__4864__auto___45341)){
args__4870__auto__.push((arguments[i__4865__auto___45342]));

var G__45343 = (i__4865__auto___45342 + (1));
i__4865__auto___45342 = G__45343;
continue;
} else {
}
break;
...
var vec__45181 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45181,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45181,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__45345__delegate = function (add_fmt,add_args){
...
var G__45345 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__45349__i = 0, G__45349__a = new Array(arguments.length -  1);
while (G__45349__i < G__45349__a.length) {G__45349__a[G__45349__i] = arguments[G__45349__i + 1]; ++G__45349__i;}
  add_args = new cljs.core.IndexedSeq(G__45349__a,0,null);
} 
return G__45345__delegate.call(this,add_fmt,add_args);};
G__45345.cljs$lang$maxFixedArity = 1;
G__45345.cljs$lang$applyTo = (function (arglist__45353){
var add_fmt = cljs.core.first(arglist__45353);
var add_args = cljs.core.rest(arglist__45353);
return G__45345__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq45170){
var G__45171 = cljs.core.first(seq45170);
var seq45170__$1 = cljs.core.next(seq45170);
var G__45172 = cljs.core.first(seq45170__$1);
var seq45170__$2 = cljs.core.next(seq45170__$1);
var G__45173 = cljs.core.first(seq45170__$2);
var seq45170__$3 = cljs.core.next(seq45170__$2);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45171,G__45172,G__45173,seq45170__$3);
}));
...
var seq__45206 = cljs.core.seq(features);
var chunk__45207 = null;
var count__45208 = (0);
var i__45209 = (0);
while(true){
if((i__45209 < count__45208)){
var feature = chunk__45207.cljs$core$IIndexed$_nth$arity$2(null,i__45209);
...
var G__45359 = seq__45206;
var G__45360 = chunk__45207;
var G__45361 = count__45208;
var G__45362 = (i__45209 + (1));
seq__45206 = G__45359;
chunk__45207 = G__45360;
count__45208 = G__45361;
i__45209 = G__45362;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__45206);
if(temp__5753__auto__){
var seq__45206__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__45206__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__45206__$1);
var G__45363 = cljs.core.chunk_rest(seq__45206__$1);
var G__45364 = c__4679__auto__;
var G__45365 = cljs.core.count(c__4679__auto__);
var G__45366 = (0);
seq__45206 = G__45363;
chunk__45207 = G__45364;
count__45208 = G__45365;
i__45209 = G__45366;
continue;
} else {
var feature = cljs.core.first(seq__45206__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__45367 = cljs.core.next(seq__45206__$1);
var G__45368 = null;
var G__45369 = (0);
var G__45370 = (0);
seq__45206 = G__45367;
chunk__45207 = G__45368;
count__45208 = G__45369;
i__45209 = G__45370;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o45270 = temp__5751__auto__;
return (o45270["version"]);
} else {
return null;
}
})() == null);
